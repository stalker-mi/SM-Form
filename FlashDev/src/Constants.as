package
{
    ...
    public class Constants
    {
		...
		"Некорректная фамилия. Также поле должно быть больше 1 символа",
		"Некорректный e-mail",
		"Логин должен начинаться с буквы, далее буквы и цифры:2-10 сиволов",
		"Введите пароль",
		"Некорректный пароль. Пароль должен содержать минимум 5 символов",
		"Пароли не совпадают",
		"Пароль ненадежный"
		);
